    ...
    <header class="w-full bg-green-700">
        <nav class="flex p-4 mb-2">
            ...
            <ul class="flex gap-8 items-center place-content-center m-auto font-semibold ">
                <li class="p-2 hover:text-white"><a href="home">Home</a></li>
                <li class="p-2 hover:text-white"><a href="booking">Booking</a></li>
                <li class="p-2 hover:text-white"><a href="myorder">My Booking</a></li>
